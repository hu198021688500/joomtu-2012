...
insert  into `jt_assignment`(`itemname`,`userid`,`bizrule`,`data`) values ('Administrator','11','','s:0:\"\";');
...
insert  into `jt_item`(`name`,`type`,`description`,`bizrule`,`data`) values ('Authority',2,NULL,NULL,NULL),('Administrator',2,NULL,NULL,NULL),('User',2,NULL,NULL,NULL),('Post Manager',1,NULL,NULL,NULL),('User Manager',1,NULL,NULL,NULL),('Delete Post',0,'[ModuleId]/[Subdirectory].[ControllerId][Action]','','s:0:\"\";'),('Create Post',0,NULL,NULL,NULL),('Edit Post',0,NULL,NULL,NULL),('View Post',0,NULL,NULL,NULL),('Delete User',0,NULL,NULL,NULL),('Create User',0,NULL,NULL,NULL),('Edit User',0,NULL,NULL,NULL),('View User',0,NULL,NULL,NULL),('PostViewing',1,'','','s:0:\"\";'),('posts_admin.PostDelete',0,'','','s:0:\"\";');
...
insert  into `jt_item_children`(`parent`,`child`) values ('Administrator','User Manager'),('User Manager','Create User');
