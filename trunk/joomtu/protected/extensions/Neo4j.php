...
class Neo4j {
	...
	public function deleteNode($nid) {
		list($this->errorCode, $data) = $this->curlRequest('node/' . $nid, null, 'DELETE');
	...
	public function removeItemsFromIndexWithoutSupplyingValue($type, $key, $id) {
		$myWhat = '';
		switch ($type) {
			case 'node':$myWhat = 'my_nodes';break;
			case 'relationship':$myWhat = 'my_relationships';break;
			default:break;
		}
	...
	public function indexSearch($query,$isKey) {
		...
		switch ($type) {
			case 'node':$myWhat = 'my_nodes';break;
			case 'relationship':$myWhat = 'my_rels';break;
			default:break;
		}
